...
var favoriteThings = {
  ...
  holiday: "I do not like Holidays"
}
...
//Code Here
makePerson = (name, birthday, ssn) => { return {name: name, birthday: birthday, ssn: ssn}}
...
//Code Here
makeCard = (cardNumber, expirationDate, securityCode) => {return {cardNumber, expirationDate, securityCode}}
